...
buttons.each(function () {
  $(this).click(function () {
    ...
    const price = parseFloat(
      cardContainer.find(".dog-price").text().split("$")[1]
    );
    ...
    if ($(this).text() === "Adopt") {
      ...
      alert(
        `You've added ${dogName} to your cart. \n\nYour total is now $${total.toFixed(
          2
        )}`
      );
    } else {
...
const blogPosts = [
  {
    ...
    content:
      "ASADA!! Tacos al pastor made with adobada meat. I think I’ve overdosed on tacos. Fish tacos with cabbage slaw and a side of chips and guac. Josh’s taco shack is the best taco shack. Give me tacos, or give me death. Can you put some peppers and onions on that? Say taco one more time. CARNE ASADA!! Carne asada on corn tortillas. Tacos, again? This will be 5 times this week and it’s only Tuesday. CARNITAS!!"
  },
  {
