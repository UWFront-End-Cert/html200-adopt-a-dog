...
const blog_one = ["./images/blog-1.jpg", "Girl sitting with arm around dog in the canyons", "Traveling With Your Dog"];
const blog_two = ["./images/blog-2.jpg", "Multiple Dogs on a leash going for a walk", "How To Walk Multiple Dogs"];
const blog_three = ["./images/blog-3.jpg", "Girl holding ball during sunset while dog patiently waits for her to throw it", "Teach Your Dog To Fetch!"];
